...
This appendix documents the \textit{Open Paper Machine specifically}---its plugin structure and orchestration dialogue. For general background on transformer architecture, RLHF, and Constitutional AI, see Section~\ref{sec:theory}.
