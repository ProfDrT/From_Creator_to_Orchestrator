...
\node[rounded corners=4pt, fill=lightgray, inner sep=6pt, text width=15.5cm, align=center] {
    {\small\textbf{21 pages} \quad\textbullet\quad \textbf{2 figures} \quad\textbullet\quad \textbf{3 tables} \quad\textbullet\quad \textbf{53 references} \quad\textbullet\quad \textbf{8 sections + appendices}}\\[2pt]
...
\node[phase, fill=argument] (p5) at (0,-6.2)
    {\textbf{5. Argument} {\footnotesize(\S6)} \hfill \colorbox{c1color}{\color{white}\scriptsize\bfseries C1}\\[1pt]
     {\small Task redistribution, desk research provocation, authorship. \figref{2}: \textbf{the central framework.}}};
...
\S6.4 Authorship & \Cone & Accountability-based framework \\
